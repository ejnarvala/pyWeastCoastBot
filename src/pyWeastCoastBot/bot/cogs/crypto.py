...
from pyWeastCoastBot.lib.crypto.cg import CoinGeckoClient
...
class CryptoCoinResponse:
    ...
    def to_embed(self):
        ...
        embed.add_field(name="Price", value=format_money(self.coin.market_data.current_price), inline=True)
        embed.add_field(
            name="Percent Change",
